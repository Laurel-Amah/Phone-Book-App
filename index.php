    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr>
                        ...
                        <td>" . $row["phone"] . "</td>
                        <td><a href='edit.php?id=" . $id . "' class='btn-link'>
                        <span class='material-symbols-outlined' title='Edit Contact'>edit_square</span>
                        </a></td>
                        <td><a href='delete.php?id=" . $id . "' class='btn-link' id='delete' onclick='return confirm(\"Are you sure you want to delete this contact?\");'> 
                         <span class='material-symbols-outlined' title='Delete Contact'>delete</span>
                        </a></td>
                    </tr>";
            $i++;
        }
